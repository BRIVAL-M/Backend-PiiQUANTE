...
const port = normalizePort(process.env.PORT || '3000'); // Define the server to listen on the port 3000 and the errorHandler to handle the errors
app.set('port', port);
...
server.listen(port);// Listen on the port defined in the variable port
